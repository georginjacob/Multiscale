% Analysis code- Experiment 04
% Position Size and Numerocity
clc;clear all;close all;
load('L2_IEpossizenum.mat');
%% CONSTANTS
Set_Num=4;
StimuliPerSet=25;
...
figure('Name','Panel-C');
simplot((1./RT_avg_mean(1:Image_Pair_Size)),INPUT_IMAGES_v(1:StimuliPerSet),0.1);

%% Setwise correlation between observed Dissimilarities
figure;
Index1=1:300;
Index2=301:600;
Index3=601:900;
Index4=901:1200;
subplot 131
corrplot(dobs_value(Index1,1),dobs_value(Index2,1));unityslope;
xlabel('dobs,Set1')
ylabel('dobs,Set2')
axis([0,2,0,2])

subplot 132
corrplot(dobs_value(Index1,1),dobs_value(Index3,1));unityslope;
xlabel('dobs,Set1')
ylabel('dobs,Set3')
axis([0,2,0,2])

subplot 133
corrplot(dobs_value(Index1,1),dobs_value(Index4,1));unityslope;
xlabel('dobs,Set1')
ylabel('dobs,Set4')
axis([0,2,0,2])
%% Modelling
...
bar(mean_coeff)
hold on
Xpos=[(1:4)-0.25;(1:4)-0.1;(1:4)+0.1;(1:4)+0.25];
...
for i=1:Image_Pair_Size
    ...
    g2=L2_str.Image_Pair_Details(i,9);
    l1=L2_str.Image_Pair_Details(i,2);
    l2=L2_str.Image_Pair_Details(i,8);
